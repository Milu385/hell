...
namespace entregable1
{
    public class Combatsystem
    {
        ...
        public Combatsystem()
        {
            ...
            Enemies = new Ienemies[random.NextInt64(1, 2)];
            ...
            for (int i = 0; i < Enemies.Length; i++)
            {
                ...
                if (TipoEnemigos == 1)
                {
                    Enemies[i] = new Goblin(random.Next(5, 15));
                }
                if (TipoEnemigos == 2)
                {
                    Enemies[i] = new Vampire(random.Next(10, 25));
                }
        ...
        public void CombatMode(Character personaje)
        {
